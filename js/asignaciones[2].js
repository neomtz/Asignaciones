...
var momento = $('#calendar').fullCalendar('getDate');
 ...
 if (a==1)
 {
  ...
  if(sessionStorage.getItem("source") == "74452baadc5779020cf126d8bee3ae0552b86ef5850d1e08f3c4f8e0482783dc80754dff")
   ...
   formulario += '<input type="date" id="date1" class="form-control formulario1" placeholder=""/><input type="date" id="datef1" class="form-control formulario1" placeholder=""/><button type="button" class="btn btn-light" id="btnMas" ultimo="1"><i class="fa fa-plus"></i></button>  </div>';
...
function getUsuarios()
{
  ...
  token = '7c3983f1e14a8ac35b35ee8b2d0ea8ae368f17bb47b4a5dd6706cbe9bfb2e842fcb2f033';
		$.ajax(
	  {
	   ...
	   url: "../Usuarios/GET/?source=lista&source2=getall",
			...
			$.ajax(
				{
				 type: "POST", // aqui defino el canal de envio de datos GET o POST
				 dataType: "JSON", // aqui determino el tipo de dato en el que me debe responder el servidor, puede ser html /text / xml
				 url: "../Sucursales/GET/?source=sucursal&source2=getall",
			...
			$.ajax(
				{
				 type: "POST", // aqui defino el canal de envio de datos GET o POST
				 dataType: "JSON", // aqui determino el tipo de dato en el que me debe responder el servidor, puede ser html /text / xml
				 url: "../"+rutaGrupos+"/GET/?source=grupos&source2=datosgruposall",
...
function setAsignacion(i,tipo)
{
 ...
 var dataPost={source1:idchecklist, source2:idgrupo, source3:idsucursal, source4:idusuario, source5:fecha, source55:fechaf,source6:'', source7:'4', source: sessionStorage.getItem("source"),'sourcejson': json }
 if(tipo == 2)
 {
  ...
  dataPost={ 'source1':idchecklist, 'source2':idgrupo, 'source3':idusuario, 'source4':idsucursal, 'source5':fecha,'source55':fechaf, 'source6':'', 'source7':'4', 'source': sessionStorage.getItem("source"), 'sourcejson': json}
 }
  $.ajax(
  {
   type: "POST",
