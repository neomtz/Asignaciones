...
if($_GET['source2'] == 'setasign')
{
  ...
  if(empty($_POST['source5']))
   ...
   if( $art->setItem($json,$idi,$_POST['source0'],$fecha) && $art->setItemAsignado($idi,$_POST['source1'],$_POST['source2'],$_POST['source3'],$_POST['source4'],$fechaf,$_POST['source6'],$_POST['source7']) )
   {
    $server['status'] = 'ok';
    $server['id'] = $idi;
    $server['fecha'] = $fecha;
